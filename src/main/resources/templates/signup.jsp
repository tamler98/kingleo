...
<body>
  ...
  <div id="formContent">
    ...
    <!-- Tabs Titles -->
    <a href="login"><h2 class="inactive underlineHover" style="cursor: pointer;"> Đăng nhập </h2></a>
    <a href="signup"><h2 class="active" style="cursor: pointer;">Đăng ký </h2></a>

    <!-- Login Form -->
    <p id="msg" style="color: red; font-weight: 500;" th:text="${msg}" class="notification"></p>
    <form action="signup" method="POST" modelAttribute="account">
      ...
      <input type="password" id="password" class="fadeIn second" name="password_repeat" placeholder="Nhập lại mật khẩu">
      <input type="email" id="login" class="fadeIn second" name="email" placeholder="Email">
      <input type="text" id="phone" class="fadeIn third" name="phone" placeholder="Số điện thoại">
      <input type="submit" class="fadeIn fourth" value="Đăng ký tài khoản" style="margin-top: 20px;cursor: pointer;">
    </form>
