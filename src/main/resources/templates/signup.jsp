...
<body>
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <!-- Tabs Titles -->
            <a href="login">
                <h2 class="inactive underlineHover" style="cursor: pointer;"> Đăng nhập </h2>
            </a>
            <a href="signup">
                <h2 class="active" style="cursor: pointer;">Đăng ký </h2>
            </a>
            ...
            <form action="signup" method="POST" modelAttribute="account">
                <input type="text" id="login" class="fadeIn second" name="username" placeholder="Tài khoản" required>
                <input type="password" id="password" class="fadeIn third" name="password" placeholder="Mật khẩu"
                    minlength="6" required>
                <input type="password" id="password" class="fadeIn second" name="password_repeat"
                ...
                <input type="text" id="phone" class="fadeIn third" name="phone" placeholder="Số điện thoại" required>
                <input type="submit" class="fadeIn fourth" value="Đăng ký tài khoản"
