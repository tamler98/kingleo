                ...
                <div class="pagination">
                    <span th:if="${totalPages > 1}">
                        <span th:if="${currentPage > 0}">
                            <a th:href="@{/search(keyword=${param.keyword}, page=${currentPage - 1})}">&laquo;</a>
                        </span>
                        <span th:each="i : ${#numbers.sequence(0, totalPages - 1)}">
                            <a th:href="@{/search(keyword=${param.keyword}, page=${i})}" th:text="${i + 1}" th:class="${currentPage == i ? 'active-page' : ''}"></a>
                        </span>
                        <span th:if="${currentPage < totalPages - 1}">
                            <a th:href="@{/search(keyword=${param.keyword}, page=${currentPage + 1})}">&raquo;</a>
                        </span>
                    </span>
                </div>
            </div>
