...
<body id="reportsPage">
            ...
            <div class="container h-100">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto h-100">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" th:href="productView">
    ...
    <script src="../resources/static/js/admin/jquery-3.3.1.min.js"></script>
    <!-- https://jquery.com/download/ -->
    <script src="../resources/static/js/admin/moment.min.js"></script>
    <!-- https://momentjs.com/ -->
    <script src="../resources/static/js/admin/Chart.min.js"></script>
    <!-- http://www.chartjs.org/docs/latest/ -->
    <script src="../resources/static/js/admin/bootstrap.min.js"></script>
    <!-- https://getbootstrap.com/ -->
    <script src="../resources/static/js/admin/tooplate-scripts.js"></script>
    <script>
