                                        ...
                                        <div class="thumb-content">
                                            ...
                                            <div class="choose_color">
                                                ...
                                                <div th:each="color : ${item.productColorEntities}">
                                                    <button class="color_btn" th:id="'colorInput_' + ${item.id}"
                                            ...
                                            <div class="choose_size">
                                                ...
                                                <button type="button" class="size_btn" th:id="'sizeInput_' + ${item.id}"
                                                    th:text="38"
                                                    th:attr="data-product-id=${item.id}, data-size='38', onclick='setSize(this, event)'">
                                                </button>
                                                <button type="button" class="size_btn" th:id="'sizeInput_' + ${item.id}"
                                                    th:text="39"
                                                    th:attr="data-product-id=${item.id}, data-size='39', onclick='setSize(this, event)'">
                                                </button>
                                                <button class="size_btn" th:id="'sizeInput_' + ${item.id}" th:text="40"
                                                    th:attr="data-product-id=${item.id}, data-size='40', onclick='setSize(this, event)'">
                                                </button>
                                                <button class="size_btn" th:id="'sizeInput_' + ${item.id}" th:text="41"
                                                    th:attr="data-product-id=${item.id}, data-size='41', onclick='setSize(this, event)'">
                                                </button>
                                                <button class="size_btn" th:id="'sizeInput_' + ${item.id}" th:text="42"
                                                    th:attr="data-product-id=${item.id}, data-size='42', onclick='setSize(this, event)'">
                                                </button>
...
<script>
    ...
    function updateOrderDetails() {
        ...
        var size = document.querySelector(".size_btn.selected").getAttribute("data-size");
