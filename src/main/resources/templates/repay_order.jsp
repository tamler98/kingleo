                 ...
                 <div class="card" style="border-radius: 10px;">
                   ...
                   <div class="card-body p-4">
                     <div class="d-flex justify-content-between align-items-center mb-4">
                       ...
                       <p class="small text-muted mb-0">Mã VĐ: <span th:text="${session.orderDetailList[0].orderEntity.orderCode}"></span></p>
                     </div>
                     <div class="card shadow-0 border mb-4" th:each="item :${session.orderDetailList}">
                       <div class="card-body">
                         <div class="row">
                           <div class="col-md-2">
                    ...
                    <div class="order_footer_info">
                     ...
                     <div class="d-flex justify-content-between pt-2">
                       <p class="text-muted mb-0" style="width: 60%; line-height:25px;">Phí ship : <span style="font-weight: bold;" th:text="${session.orderDetailList[0].cod_shipping}">Thanh Tâm</span></p>
                     </div>
                     <div class="d-flex justify-content-between pt-2">
                       <p class="text-muted mb-0" style="width: 60%; line-height:25px;">Giảm giá : <span style="font-weight: bold;" th:text="${session.orderDetailList[0].discount}">Thanh Tâm</span></p>
                     </div>
                     <div class="d-flex justify-content-between pt-2">
                       <p class="text-muted mb-0" style="width: 60%; line-height:25px;">Thành tiền : <span style="font-weight: bold;" th:text="${session.orderDetailList[0].orderEntity.totalPrice}">Thanh Tâm</span></p>
                     </div>
                     </div>
                     ...
                     <div class="d-flex justify-content-between pt-2">
                       <p class="text-muted mb-0" style="width: 60%; line-height:25px;">Người nhận : <span style="font-weight: bold;" th:text="${session.orderDetailList[0].customer_name}">Thanh Tâm</span></p>
                     </div>
                     <div class="d-flex justify-content-between pt-2">
                       <p class="text-muted mb-0" style="width: 60%; line-height:25px;">Số điện thoại : <span style="font-weight: bold;" th:text="${session.orderDetailList[0].customer_phone}">Thanh Tâm</span></p>
                     </div>
                     <div class="d-flex justify-content-between pt-2">
                       <p class="text-muted mb-0" style="width: 60%; line-height:25px;">Địa chỉ : <span style="font-weight: bold;" th:text="${session.orderDetailList[0].customer_address}">Thanh Tâm</span></p>
                     </div>
                     <div class="d-flex justify-content-between pt-2">
                       <p class="text-muted mb-0" style="width: 60%; line-height:25px;">Ngày đặt : <span style="font-weight: bold;" th:text="${session.orderDetailList[0].orderEntity.orderDate}">Thanh Tâm</span></p>
                     </div>
                     </div>
                     </div>
                   <form th:action="repayorder" method="POST">
                   <div class="card-footer border-0 px-4 py-5"
                     style="background-color: #18b5f9; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
                     <h5 class="d-flex align-items-center justify-content-center text-white text-uppercase mb-0"><button class="h2 mb-0 ms-2"> 300.000 VNĐ</button></h5>
                   </div>
                   </form>
                 </div>
                 </div>
