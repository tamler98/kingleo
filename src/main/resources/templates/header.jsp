          ...
          <div class="row">
              <div class="col-sm-2" style="padding-top: 5px;display: flex;justify-content: right;">
                  <div class="header_logo">
                      <a href="/"><img src="../resources/static/images/logo_KL-06.png" style="height: 70px;" alt=""></a>
                  </div>
              </div>
              <div class="col-sm-6">
              ...
              <div class="col-sm-4">
                  ...
                  <div class="account_icons" th:if="${session.account != null}">
                      <ul>
                          <li>
                            <img src="../resources/static/images/tam.jpg" class="profile" />
                            <ul>
                              <li class="sub-item">
                                  <span class="material-icons-outlined"> <i class="far fa-user"></i> </span>
                              ...
                              <li class="sub-item">
                                <span class="material-icons-outlined"> <i class="fas fa-users-cog"></i> </span>
                                <p>Update Profile</p>
                              </li>
                              <a href="../logout" class="logout">
                              <li class="sub-item">
                                <span class="material-icons-outlined"> <i class="fas fa-sign-out-alt"></i> </span>
                                <p>Logout</p>
                              </li>
                              </a>
                            </ul>
                          ...
                          <li>
                              <span class="material-icons-outlined" style="padding-top: 23px; font-size: 27px;">
                                  <i class="fas fa-cart-plus"></i>
                              </span>
                              <p><span class='badge badge-warning' id='lblCartCount' th:text="${session.count}"></span></p>
                          </li>
                        </ul>
                  </div>
                  <div class="account_icons" th:if="${session.account == null}">
