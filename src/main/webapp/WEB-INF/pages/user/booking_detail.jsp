            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Booking /</span> Booking Details
                        </h4>
                                    ...
                                    <tbody class="table-border-bottom-0">
                                        <c:forEach var="item" items="${bookingDetails}">
                                            <tr>
                                                ...
                                                <td>
                                                    <fmt:formatDate value="${item.booking_check_in}"
                                                        pattern="dd-MM-yyyy" />
                                                </td>
                                                <td>
                                                    <fmt:formatDate value="${item.booking_check_out}"
                                                        pattern="dd-MM-yyyy" />
                                                </td>
                                                <td>${item.total_night}</td>
                                                <td>
                                                    <fmt:formatNumber
                                                        value="${item.roomEntity.categoryEntity.price*item.total_night}" />
                                                    VND
                                                </td>
                                            </tr>
                                        </c:forEach>
