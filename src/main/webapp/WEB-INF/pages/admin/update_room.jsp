...
<html lang="en" class="light-style customizer-hide" dir="ltr" data-theme="theme-default"
    data-assets-path="resources/static/assets/" data-template="vertical-menu-template-free">
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form:form action="${action}" modelAttribute="room" method="post" id="formAuthentication"
                            class="mb-3">
                            ...
                            <c:if test="${type.equals('update')}">
                                <div class="mb-3">
                                    ...
                                    <form:input path="id" type="text" class="form-control" id="id" disabled="true" />
                                    <form:hidden path="id" />
                            ...
                            <div class="mb-3">
                                ...
                                <form:input path="room_name" type="text" class="form-control" id="username"
                                    name="username" placeholder="Enter room name" />
                            ...
                            <div class="mb-3">
                                ...
                                <form:input path="room_number" type="number" class="form-control" id="email"
                                    name="email" placeholder="Enter room number" />
                                <small style="color: red">
                                    <c:out value="${error_duplicate}" />
                                </small>
                                <small style="color: red">
                            ...
                            <div class="mb-3">
                                ...
                                <form:select path="room_status" class="form-control" id="status" name="status">
                                    <c:forEach items="${roomStatusList}" var="roomStatus">
                                        <form:option value="${roomStatus}" label="${roomStatus}" />
                                    </c:forEach>
                                </form:select>
                            </div>
                            <div class="mb-3">
                                <select name="categoryId" class="form-control">
                                    <option value="${room.categoryEntity.id}">${room.categoryEntity.category_name}</option>
